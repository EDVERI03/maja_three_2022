    ...
    <form action="?/createNewCategory" method="POST" class="formbox" use:enhance>
        ...
        <div class="blockbox">
            ...
            <div class="spacerbox">
                ...
                <input type="radio" name="{question}_isCorrect" id="{question}_isCorrect" class="checkbox sky-check">
            </div>
            <div class="spacerbox">
                <input type="text" name="{question}_answer2" id="{question}_answer2" placeholder="Option 2" class="inputbox peach-text">
                <input type="radio" name="{question}_isCorrect" id="{question}_isCorrect" class="checkbox peach-check">
            </div>
            <div class="spacerbox">
                <input type="text" name="{question}_answer3" id="{question}_answer3" placeholder="Option 3" class="inputbox signal-text">
                <input type="radio" name="{question}_isCorrect" id="{question}_isCorrect" class="checkbox signal-check">
            </div>
        </div>
        {/each}
